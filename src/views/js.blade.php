...
<script src="{{ asset($bpas_admin_theme_pkg_prefix.'public/themes/'.$theme.'/js/theme.js')}}"></script>
<script src="{{ asset($bpas_admin_theme_pkg_prefix.'public/themes/'.$theme.'/js/common.js')}}"></script>
