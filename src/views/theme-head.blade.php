...
<link rel="stylesheet" type="text/css" href="{{ asset($bpas_admin_theme_pkg_prefix.'public/themes/'.$theme.'/less/responsive.css') }}">
<link href="{{ asset($bpas_admin_theme_pkg_prefix.'public/themes/'.$theme.'/css/custom.css') }}" rel="stylesheet" type="text/css" />
<!-- Custom CSS -->
